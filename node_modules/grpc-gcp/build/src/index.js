...
const setup = (grpc) => {
    ...
    function gcpCallInvocationTransformer(callProperties) {
        ...
        let affinityKeyFromCallOptions;
        // Check if CallOptions contains the affinity key
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        if (affinityConfig && callOptions.affinityKey) {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            affinityKeyFromCallOptions = callOptions.affinityKey;
        }
        const preProcessResult = preProcess(channelFactory, affinityConfig, argument, affinityKeyFromCallOptions);
                    ...
                    const newListener = {
                        ...
                        onReceiveStatus: (status, next) => {
                            ...
                            if (status.code === grpc.status.OK) {
                                postProcess(channelFactory, channelRef, affinityConfig, boundKey, firstMessage);
                            }
     ...
     * object.
     */
    function preProcess(channelFactory, 
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    affinityConfig, 
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    argument, overrideAffinityKey) {
     ...
     */
    function postProcess(channelFactory, channelRef, 
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    affinityConfig, boundKey, 
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    responseMsg) {
