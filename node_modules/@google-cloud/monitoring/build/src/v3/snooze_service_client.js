...
exports.SnoozeServiceClient = void 0;
 ...
 */
const gapicConfig = require("./snooze_service_client_config.json");
...
class SnoozeServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listSnoozes: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'snoozes'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.monitoring.v3.SnoozeService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.snoozeServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.monitoring.v3.SnoozeService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.monitoring.v3.SnoozeService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of snoozeServiceStubMethods) {
            const callPromise = this.snoozeServiceStub.then((stub) => (...args) => {
                if (this._terminated) {
    ...
    createSnooze(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    getSnooze(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    updateSnooze(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listSnoozes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listSnoozesStream(request, options) {
        ...
        return this.descriptors.page.listSnoozes.createStream(this.innerApiCalls.listSnoozes, request, callSettings);
    }
    /**
    ...
    listSnoozesAsync(request, options) {
        ...
        return this.descriptors.page.listSnoozes.asyncIterate(this.innerApiCalls['listSnoozes'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.SnoozeServiceClient = SnoozeServiceClient;
//# sourceMappingURL=snooze_service_client.js.map