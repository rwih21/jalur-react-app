...
class NotificationChannelServiceClient {
    ...
    initialize() {
        ...
        this.notificationChannelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ...
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.monitoring.v3.NotificationChannelService, this._opts, this._providedCustomServicePath);
    ...
    sendNotificationChannelVerificationCode(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .sendNotificationChannelVerificationCode(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('sendNotificationChannelVerificationCode response %j', response);
            return [response, options, rawResponse];
        })
