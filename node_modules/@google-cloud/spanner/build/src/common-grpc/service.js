...
class ObjectToStructConverter {
    ...
    convert(obj) {
        ...
        for (const prop in obj) {
            if (Object.prototype.hasOwnProperty.call(obj, prop)) {
                ...
                if ((0, helper_2.isUndefined)(value)) {
                    continue;
                }
    ...
    encodeValue_(value) {
        let convertedValue;
        if ((0, helper_2.isNull)(value)) {
            convertedValue = {
                nullValue: 0,
            };
        }
        else if ((0, helper_2.isNumber)(value)) {
            convertedValue = {
                numberValue: value,
            };
        }
        else if ((0, helper_2.isString)(value)) {
            convertedValue = {
                stringValue: value,
            };
        }
        else if ((0, helper_2.isBoolean)(value)) {
            convertedValue = {
                boolValue: value,
            };
        }
        ...
        else if ((0, helper_2.isObject)(value)) {
        ...
        else if ((0, helper_2.isArray)(value)) {
            convertedValue = {
                listValue: {
...
class GrpcService extends common_1.Service {
    ...
    requestWritableStream(protoOpts, reqOpts) {
        ...
        const grpcMetadata = this.grpcMetadata;
        const grpcOpts = {};
        if ((0, helper_2.isNumber)(protoOpts.timeout)) {
            grpcOpts.deadline = GrpcService.createDeadline_(protoOpts.timeout);
        }
        try {
            reqOpts = this.decorateRequest_(reqOpts);
    ...
    static decorateError_(err) {
        const errorObj = (0, helper_2.isError)(err) ? err : {};
    ...
    decorateRequest_(reqOpts) {
        ...
        return (0, helper_1.replaceProjectIdToken)(reqOpts, this.projectId);
    }
    /**
