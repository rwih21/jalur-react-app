...
class SessionPool extends events_1.EventEmitter {
    ...
    async _createSessions(amount) {
        ...
        return api_1.context.with(api_1.ROOT_CONTEXT, () => {
    ...
    _startHouseKeeping() {
        ...
        this._evictHandle = api_1.context.with(api_1.ROOT_CONTEXT, () => setInterval(() => this._evictIdleSessions(), evictRate));
        this._evictHandle.unref();
        const pingRate = this.options.keepAlive * 60000;
        this._pingHandle = api_1.context.with(api_1.ROOT_CONTEXT, () => setInterval(() => this._pingIdleSessions(), pingRate));
