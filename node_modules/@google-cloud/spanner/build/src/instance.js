...
var databaseAdmin = spanner_api_1.protos.google;
/**
...
class Instance extends common.GrpcServiceObject {
    ...
    createDatabase(name, optionsOrCallback, cb) {
        ...
        if (databaseAdmin.spanner.admin.database.v1.DatabaseDialect.POSTGRESQL ===
     ...
     * ```
     */
    database(name, poolOptions, queryOptions, databaseRole) {
        if (!name) {
        ...
        if (!this.databases_.has(key)) {
            const db = new database_1.Database(this, name, poolOptions, queryOptions, databaseRole);
