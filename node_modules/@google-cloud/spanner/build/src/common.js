...
exports.AFE_SERVER_TIMING_HEADER = exports.END_TO_END_TRACING_HEADER = exports.LEADER_AWARE_ROUTING_HEADER = exports.CLOUD_RESOURCE_HEADER = void 0;
 ...
 */
exports.AFE_SERVER_TIMING_HEADER = 'x-goog-spanner-enable-afe-server-timing';
/**
...
function getCommonHeaders(resourceName, enableTracing) {
    ...
    if (_1.Spanner.isAFEServerTimingEnabled()) {
        headers[exports.AFE_SERVER_TIMING_HEADER] = 'true';
    }
